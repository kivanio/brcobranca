...
RSpec.describe Brcobranca::Boleto::Sicredi do
  ...
  it 'Criar nova instancia com atributos válidos' do
    ...
    expect(boleto_novo.numero_documento).to eql('08879')
  ...
  context 'carteira número 1' do
    ...
    it 'case 2' do
      ...
      valid_attributes[:numero_documento] = '08902'
      boleto_novo = described_class.new(valid_attributes)
    ...
    it 'case 3' do
      valid_attributes[:valor] = 700.00
      valid_attributes[:data_vencimento] = Date.parse('2016-07-25')
      valid_attributes[:numero_documento] = '8896'
      boleto_novo = described_class.new(valid_attributes)
    ...
    it 'case 4' do
      valid_attributes[:valor] = 700.00
      valid_attributes[:data_vencimento] = Date.parse('2016-07-25')
      valid_attributes[:numero_documento] = '8899'
      boleto_novo = described_class.new(valid_attributes)
    ...
    it 'case 5' do
      ...
      valid_attributes[:data_vencimento] = Date.parse('2016-07-25')
      valid_attributes[:numero_documento] = '8878'
      boleto_novo = described_class.new(valid_attributes)
    ...
    it 'case 6' do
      ...
      valid_attributes[:numero_documento] = '9048'
      boleto_novo = described_class.new(valid_attributes)
