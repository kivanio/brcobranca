    ...
    module Cnab240
      ...
      class Santander < Brcobranca::Retorno::Cnab240::Base
        ...
        class Line < Base
          ...
          REGISTRO_T_FIELDS = %w(codigo_ocorrencia agencia_com_dv cedente_com_dv nosso_numero nosso_numero_com_dv carteira data_vencimento valor_titulo banco_recebedor agencia_recebedora_com_dv sequencial valor_tarifa motivo_ocorrencia).freeze
