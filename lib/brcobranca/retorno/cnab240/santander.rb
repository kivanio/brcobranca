    ...
    module Cnab240
      class Santander < Brcobranca::Retorno::Cnab240::Base
        ...
        class Line < Base
          ...
          REGISTRO_U_FIELDS = %w[desconto_concedito data_ocorrencia valor_abatimento iof_desconto juros_mora
                                 valor_recebido outras_despesas outros_recebimento data_credito].freeze
          ...
          fixed_width_layout do |parse|
            ...
            parse.field :motivo_ocorrencia, 208..117, lambda { |motivos|
