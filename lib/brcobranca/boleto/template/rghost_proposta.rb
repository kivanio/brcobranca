    ...
    module Template
      ...
      module RghostProposta
        ...
        def modelo_proposta(boleto, options = {})
          ...
          modelo_proposta_build_data_left(doc, boleto, colunas, linhas)
          modelo_proposta_build_data_right(doc, boleto, colunas, linhas)
        ...
        # @option options [Symbol] :resolucao Resolução em pixels.
        # @option options [Symbol] :formato Formato desejado [:pdf, :jpg, :tif, :png, :ps, :laserjet, ... etc]
        def modelo_proposta_multipage(boletos, options = {})
          ...
          boletos.each_with_index do |boleto, index|
            ...
            modelo_proposta_load_background doc, margin_bottom
        ...
        def modelo_proposta_build_data_left(doc, boleto, colunas, linhas)
          # LOGOTIPO do BANCO
        ...
        def modelo_proposta_build_data_right(doc, boleto, colunas, linhas)
          # LOGOTIPO do BANCO
