    ...
    module Cnab240
      class Sicoob < Brcobranca::Remessa::Cnab240::Base
        ...
        def info_conta_header_arquivo
          # CAMPO                  TAMANHO  DEFAULT
          # agencia                5
          # digito agencia         1
          # conta corrente         12
          # digito conta           1
          # digito agencia/conta   1        0
        ...
        def formata_nosso_numero(nosso_numero)
          "#{nosso_numero.to_s.rjust(9, '0')}#{nosso_numero_dv(nosso_numero)}#{parcela}#{modalidade_carteira}#{tipo_formulario}     "
        end
        ...
        def nosso_numero_dv(nosso_numero)
          puts 'Remessa::Sicoob#nosso_numero_dv', agencia, convenio.rjust(10, '0'), nosso_numero
