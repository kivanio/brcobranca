...
Gem::Specification.new do |s|
  ...
  s.date = %q{2009-04-01}
  s.description = %q{Gem para emissao de bloquetos de cobranca para bancos brasileiros}
  ...
  s.summary = %q{Gem para emissao de bloquetos de cobranca para bancos brasileiros}
